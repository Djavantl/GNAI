...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('inclusive-radar.assistive-technologies-statuses.update', $assistiveTechnologyStatus) }}"
          method="POST">
        @csrf
        @method('PUT')
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="flex gap-4 mt-4">
                ...
                <a href="{{ route('inclusive-radar.assistive-technologies-statuses.index') }}"
