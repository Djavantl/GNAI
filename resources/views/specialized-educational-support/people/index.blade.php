...
<div class="max-w-6xl mx-auto bg-white p-6 rounded shadow">
    <div class="flex justify-between items-center mb-6">
        ...
        <a href="{{ route('specialized-educational-support.people.create') }}" class="bg-blue-500 text-white px-4 py-2 rounded">Novo Cadastro</a>
    </div>
    ...
    <table class="w-full text-left border-collapse">
        ...
        @foreach($people as $person)
            <tr class="border-b hover:bg-gray-50">
                ...
                <td class="p-2">{{ \App\Models\SpecializedEducationalSupport\Person::genderOptions()[$person->gender] ?? $person->gender }}</td>
                <td class="p-2">{{ $person->email }}</td>
                <td class="p-2 flex gap-2">
                    <a href="{{ route('specialized-educational-support.people.edit', $person) }}" class="text-orange-500">Editar</a>
