...
<div class="max-w-2xl mx-auto bg-white p-6 rounded shadow">
    <h1 class="text-2xl font-bold mb-6">
        Cadastrar Status de Material Pedagógico Acessível
    </h1>

    <form action="{{ route('accessible-educational-material-statuses.store') }}" method="POST">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="flex gap-4 mt-4">
                ...
                <a href="{{ route('accessible-educational-material-statuses.index') }}"
