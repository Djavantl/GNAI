...
<div class="max-w-4xl mx-auto bg-white p-6 rounded shadow">
    ...
    <form action="{{ route('accessible-educational-materials.store') }}" method="POST" enctype="multipart/form-data">
        @csrf
        ...
        <div class="grid grid-cols-1 gap-4">
            ...
            <div class="bg-blue-50 p-4 rounded border border-blue-100">
                ...
                <p class="text-xs text-gray-500 mt-1 italic">Você pode selecionar várias fotos de uma vez (JPEG, PNG, WEBP).</p>
            ...
            <div class="grid grid-cols-3 gap-4">
                <div>
                    ...
                    <input type="text" name="language" value="{{ old('language') }}" class="w-full border p-2 rounded" placeholder="Ex: pt-br">
                </div>
                <div>
            ...
            <div class="grid grid-cols-3 gap-4">
                ...
                <div>
                    ...
                    <input type="number" step="0.01" name="cost" value="{{ old('cost') }}" class="w-full border p-2 rounded">
                </div>
                <div>
            ...
            <div class="flex gap-4">
                <button type="submit" class="bg-green-600 hover:bg-green-700 text-white px-8 py-2 rounded shadow transition font-bold text-lg">
                    Salvar Material
                </button>
