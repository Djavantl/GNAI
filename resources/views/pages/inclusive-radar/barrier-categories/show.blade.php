...
@section('content')
    ...
    <div class="mt-3">
        <div class="custom-table-card bg-white shadow-sm">
            ...
            <div class="col-12 border-top p-4 d-flex justify-content-end align-items-center bg-light no-print">
                <div class="d-flex flex-wrap gap-3 justify-content-end">
                    @can('barrier-category.destroy')
                        <x-buttons.submit-button
                            ...
                            data-confirm-message="A categoria {{ $barrierCategory->name }} sera excluida permanentemente."
                            data-confirm-action="{{ route('inclusive-radar.barrier-categories.destroy', $barrierCategory) }}"
