...
<body>
    ...
    @forelse ($peiDisciplines as $index => $item)
        ...
        @endif
            ...
            <table class="info-table pdf-mb-10 pdf-table-fixed">
                <colgroup>
                    <col class="pdf-w-60">
                    <col class="pdf-w-40">
                </colgroup>
