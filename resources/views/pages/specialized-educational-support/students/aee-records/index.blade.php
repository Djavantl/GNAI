    ...
    <div class="custom-table-card shadow-sm border rounded-3 overflow-hidden">
        ...
        <div class="px-3 pt-3">
            <x-table.filters.form
                data-dynamic-filter
                data-target="#aee-records-index-table"
                :fields="array_values(array_filter([
                    auth()->user()->can('aee-record.view-all') ? [
        ...
        <div id="aee-records-index-table" class="p-3">
            @include('pages.specialized-educational-support.students.aee-records.partials.table')
        </div>
    </div>
