...
<section id="aee-records" class="mb-5 rounded shadow-sm">
        ...
        @canany(['aee-record.view-all', 'aee-record.view-own'])
            <div class="d-flex flex-column flex-md-row justify-content-between align-items-md-center gap-2 mt-4 pt-3 border-top">
                ...
                <div class="d-flex flex-wrap gap-2">
                    @can('aee-record.view')
                        <x-buttons.link-button
                            :href="route('specialized-educational-support.students.aee-records.history-pdf', $student)"
                            variant="secondary"
                            class="btn-sm"
                            target="_blank"
                            label="Gerar histórico de atendimentos AEE em PDF"
                        >
