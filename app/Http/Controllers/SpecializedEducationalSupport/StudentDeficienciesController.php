...
class StudentDeficienciesController extends Controller
{
    ...
    public function index(Student $student)
    {
        ...
        return view('specialized-educational-support.student-deficiencies.index', compact('student', 'deficiencies'));
    }
    ...
    public function create(Student $student)
    {
        ...
        return view('specialized-educational-support.student-deficiencies.create', compact('student', 'deficienciesList'));
    }
    ...
    public function edit(StudentDeficiencies $student_deficiency)
    {
        ...
        return view('specialized-educational-support.student-deficiencies.edit', 
