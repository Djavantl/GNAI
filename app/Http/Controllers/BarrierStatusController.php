...
use App\Http\Requests\BarrierStatusRequest;
use App\Models\BarrierStatus;
use App\Services\BarrierStatusService;
...
class BarrierStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('barrier-statuses.index', compact('statuses'));
    }

    public function create()
    {
        return view('barrier-statuses.create');
    }
