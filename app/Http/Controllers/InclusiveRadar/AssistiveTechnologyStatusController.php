...
use App\Http\Requests\InclusiveRadar\AssistiveTechnologyStatusRequest;
use App\Models\InclusiveRadar\AssistiveTechnologyStatus;
use App\Services\InclusiveRadar\AssistiveTechnologyStatusService;
...
class AssistiveTechnologyStatusController extends Controller
{
    ...
    public function index()
    {
        ...
        return view('inclusive-radar.assistive-technology-statuses.index', compact('statuses'));
    }

    public function create()
    {
        return view('inclusive-radar.assistive-technology-statuses.create');
    }
    ...
    {
        return view(
            'inclusive-radar.assistive-technology-statuses.edit',
    ...
    public function update(AssistiveTechnologyStatusRequest $request, AssistiveTechnologyStatus $assistiveTechnologyStatus)
    {
        ...
        return redirect()
            ->route('inclusive-radar.assistive-technologies-statuses.index')
